    ...
    <div class="navigation">
        ...
        <ul class="list-unstyled">
           ...
           <li class="has-submenu">
                ...
                <ul class="list-unstyled">
                    <li class="" id="inventariox">
                        <a href="/inventario">Inventarios</a>
                    </li>
                    <li class="" id="inventarioshow">
                        <a href="/inventario/show">Disponible</a>
                    </li>
                    <li class="" id="inventariocreate">
            ...
            <li class="has-submenu">
                ...
                <ul class="list-unstyled">
                    <li class="" id="proveedor">
                        <a href="/proveedor">Listado</a>
                    </li>
                    <li class="" id="proveedorcreate">
